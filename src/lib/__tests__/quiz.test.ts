...
describe("scoreQuiz", () => {
  ...
  it("routes metabolic/medical answers to clinical management", () => {
    const r = scoreQuiz({
      1: "Metabolic Plateau",
      2: "Medical & Lab Diagnostics",
      3: "Complete Health Assessment",
    });
    expect(r.title).toContain("Clinical & Metabolic");
  });

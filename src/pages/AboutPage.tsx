...
const STATS = [
  ...
  { value: 3, suffix: "", label: "Pillars of care" },
];
...
const BELIEFS = [
  ...
  },
  {
    ...
    body: "Behavioral and psychiatric care come first — nutrition and lifestyle follow.",
  },
  {
        ...
        <Container className="relative max-w-3xl text-center">
          <Reveal className="space-y-5">
            ...
            <p className="mx-auto max-w-xl text-lg leading-relaxed text-ink/70 dark:text-bone/70">
              True wellness addresses the whole person. That&rsquo;s why at
              Mindful Wellness and Behavioural Health, we treat mental health
              conditions — including depression, anxiety, ADHD, and binge
              eating disorder, which in turn affect how one perceives
              themselves — as well as offer GLP-1s and other peptides to assist
              with weight loss and other concerns including inflammation,
              sleep, and energy.
            </p>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            <Reveal className="lg:col-span-7" delay={0.1}>
              <p className="text-lg leading-relaxed text-ink/80 first-letter:float-left first-letter:mt-1 first-letter:mr-3 first-letter:font-display first-letter:text-6xl first-letter:leading-[0.7] first-letter:text-moss dark:text-bone/80 dark:first-letter:text-amber">
                Mindful Wellness and Behavioural Health was founded by a
                psychiatric nurse practitioner who had watched too many people
                cycle through
              ...
              <p className="mt-5 leading-relaxed text-ink/70 dark:text-bone/70">
                ...
                care, GLP-1 and peptide support, and non-restrictive nutrition —
                all delivered virtually. Every client receives attentive
                one-to-one guidance that respects their body, their culture,
                and the life they actually live.
              </p>
            </Reveal>
          </div>
        </Container>

      ...
      <Container className="grid grid-cols-1 gap-12 py-16 md:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-6">
          ...
          <p className="text-sm leading-relaxed text-bone/70">
            A psychiatric and behavioural health practice helping clients
            rewrite behavioral habits and build vibrant metabolic wellness.
            Care is delivered 100% virtually.
          </p>

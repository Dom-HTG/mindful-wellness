...
const QR_SERVICES = [
  ...
  { value: "Psychological Counseling", label: "Psychological Counseling & Behavioral" },
  { value: "Medical Management", label: "Medical Weight Loss Management" },
...
export function QrModal() {
  ...
  const download = () => {
    ...
    link.download = "mindful-clinic-intake-qr.png";

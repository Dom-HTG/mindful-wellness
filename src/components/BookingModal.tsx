...
const SERVICE_OPTIONS: { value: string; label: string; icon: Icon }[] = [
  { value: "Psychological Counseling", label: "Psychological Care", icon: Brain },
  { value: "Medical Management", label: "Medical Management", icon: Pulse },
...
export function BookingModal() {
  ...
  const [service, setService] = useState(
    bookingService || "Psychological Counseling",
  );
  ...
  useEffect(() => {
    ...
    setStep(1);
    setSubmitted(false);
    setService(bookingService || "Psychological Counseling");
